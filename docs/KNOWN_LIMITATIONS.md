...
- The palette can create scene YAML from the current state, list scene titles, render final/thumbnail PNGs, duplicate scenes, delete scenes, and use guarded state preview/restore. Metadata editing and reordering are available through the message protocol and are not yet represented by full palette forms.
